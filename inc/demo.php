...
function wclsr_sk_single(){
    if(get_option('sk_repeater_settings')==true){
    ...
    echo get_option( 'wclsr-notice-position', 'bottom' )=='bottom'?$wclsr_topTitle:'';
        ...
        echo '<span class="wclsr-not-added-social">'.esc_html__('Didn\'t add social media. Please add some social media.', 'wooc-click-share').'</span>';
    }
}